export const ranges = [
    ...
    },
    {
        ...
        description: 'В Яндекс Рекламе всё не так. Если у тебя есть опыт работы ' +
            ...
            'Менеджера по работе с клиентами с опытом работы 2-3 года!'
    },
    {
        k: 57 / 35,
        minM: 80,
        ...
        description: ({salary, value}) => (value && value > 124000) || salary > 97000
            ...
            : 'В Яндекс Рекламе 80 000 рублей — это средний ' +
            'совокупный доход Специалиста по работе с ' +
            'клиентами при выполнении KPI. А выполняют его более ' +
